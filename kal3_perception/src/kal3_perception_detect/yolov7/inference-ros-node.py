...
import torch
import sys
sys.path.append('/home/kal3/kal3_ws/src/kal3_perception/src/kal3_perception_detect/yolov7')
...
# CONFIGURATION BEGIN
WEIGHTS_PATH = '//home/kal3/kal3_ws/src/kal3_perception/src/kal3_perception_detect/yolov7/best_faster.pt'
AUGMENTED_INFERENCE = False
IMG_SIZE = 720
STRIDE = 32
CONF_THRES = 0.7
IOU_THRES = 0.65  # default
IN_TOPIC_CAM_IMAGES = "/camera_front/color/image_raw"
OUT_TOPIC_CAM_IMAGES_WITH_BOUNDING_BOXES = '/kal_3/trafficsigndetect/prediction/image'
OUT_TOPIC_BOUNDING_BOXES = '/kal_3/trafficsigndetect/prediction/raw'
# CONFIGURATION END
...
class MLInferenceNode:
    def __init__(self):
        ...
        self.bbox_publisher = rospy.Publisher(
            OUT_TOPIC_BOUNDING_BOXES, BoundingBoxArray, queue_size=1)
    ...
    def detect_bboxes(self, camera_img, cv2_img_timestamp):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            self.pred_image_publisher.publish(
                self.cv_bridge.cv2_to_imgmsg(im0,encoding='bgr8'))
