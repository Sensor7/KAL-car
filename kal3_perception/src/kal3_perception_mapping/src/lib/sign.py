...
class Sign:
    ...
    def get_marker(
            self, id_: int, timestamp: rospy.Time = None, frame: str = "stargazer", ns: str = 'sign'
    ) -> Marker:
        """
        ...
        Parameters:
            ...
            frame: the reference frame, should always be the default "stargazer"
